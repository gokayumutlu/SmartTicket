...
public class MyTicketsAdapter2 extends RecyclerView.Adapter<MyTicketsAdapter2.TicketsViewHolder2>{

    private List<MyTickets> tickets;
    private Context context;
    private int rowlayout;

    public MyTicketsAdapter2(List<MyTickets> tickets, int rowlayout, Context context){
    ...
    @NonNull
    @Override
    public TicketsViewHolder2 onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(rowlayout,parent,false);
        return new TicketsViewHolder2(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TicketsViewHolder2 holder, int position) {
    ...
    public static class TicketsViewHolder2 extends RecyclerView.ViewHolder{
        ...
        public TicketsViewHolder2(@NonNull View itemView) {
            super(itemView);
